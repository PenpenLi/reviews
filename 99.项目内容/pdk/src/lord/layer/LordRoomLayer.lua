...
local PATH_ROOM_UI  = "game/lord/csb/gui-lord-roomLayer.csb"
...
local CONFIG = {
	[1] = {
        RoomScore   = 1,
		AnimName 	= PREFIX .. "effect/325ddz_tiyanchang_donghua/325ddz_tiyanchang_donghua",
        AnimName2 = "app/game/pdk/res/alter/pdk3",
        BaseScore = 1,
        EnterScore = 500,
	},
	[2] = {
        RoomScore   = 200,
		AnimName 	= PREFIX .. "effect/325ddz_wanyuanchang_donghua/325ddz_wanyuanchang_donghua",
        AnimName2 = "app/game/pdk/res/alter/PDK",
        BaseScore = 10,
        EnterScore = 5000,
	},
	[3] = {
        ...
        AnimName2 = "app/game/pdk/res/alter/pdk2",
        BaseScore = 100,
        EnterScore = 50000,
	},
	--[[[4] = {
...
function LordRoomLayer:initCSB()
    ...
    self.m_pBtnRule    = self.m_pNodeMenu:getChildByName("Button_help")   --2.规则按钮
     self.m_pBtnRecord    = self.m_pNodeMenu:getChildByName("Button_1")   --2.规则按钮
     self.m_pBtnRecord:setVisible(false)
...
function LordRoomLayer:initNode()
    ...
    for i, v in pairs(CONFIG) do
        ...
        node:getChildByName("Text_name"):setString(string.format("入场%d", v.EnterScore * 0.01))
        -- node_score:setString(string.format("底分:%d", v.BaseScore * 0.01))
        ...
        -- end
        local skeNode = sp.SkeletonAnimation:createWithJsonFile(v.AnimName2 .. ".json", v.AnimName2 .. ".atlas")
        if skeNode then
            skeNode:setPosition(cc.p(0, 80))
            skeNode:setScale(0.6)
            skeNode:setAnimation( 0, "animation", true)
            node_spine:addChild(skeNode)
        end  
